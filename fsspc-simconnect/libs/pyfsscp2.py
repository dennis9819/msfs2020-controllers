"""FSSCP2 Interface Module

This module implements the fsscp2 protocol for filghtsim controllers and
provides an module manager with auto detection.
...
class FSSCPDevice:
    ...
    def __init__(self,name: str,port: str,controller):
        ...
        if fn == None:
            ...
            handlerObj = fn(self)
            _thread.start_new_thread( handlerObj.handle, () )
